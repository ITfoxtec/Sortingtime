    ...
    public class JSNLogMiddleware
    {
        ...
        private void ProcessRequest(HttpContext context)
        {
            ...
            var logRequestBase = new LogRequestBase(
                ...
                cookies: ToDictionaryFromCookieCollection(context.Request.Cookies),
                headers: headers);
        ...
        private Dictionary<string, string> ToDictionaryFromCookieCollection(IRequestCookieCollection cookies)
        {
